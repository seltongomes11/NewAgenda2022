                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <td style= "vertical-align:middle;">
                     <a href= "editar.php?idUp=<?php echo $show->id_contato;?>" title="Editar" onclick="return confirm ('Tem certeza que deseja editar o contato')" class="btn btn-success"><img style="width:15px;" src="img/svg/editar.png"></a>
                     <a href= "deletar.php?idDel=<?php echo $show->id_contato;?>" onclick="return confirm ('Tem certeza que deseja remover o contato')" title= "Remover" class="btn btn-danger"><img style="width:15px;" src="img/svg/remover.png"></a>
