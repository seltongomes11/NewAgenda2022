<?php 
  ...
  session_start();
  if(isset($_SESSION['loginUser'])&&(isset($_SESSION['senha']))){
    ...
    <div class="card-body login-card-body">
      ...
      <?php
        if(isset($_POST['btnlogin]'])){
          $email=$_POST['email'];
          $senha=$_POST['senha'];
          $select="SELECT * FROM tb_atividade WHERE email_atividade=:emailLogin AND senha_atividade=:senhaLogin";
          try{
            ...
            echo "<strong>ERRO DE LOGIN</strong>".$erro->geMessage();          }
        }
      ?>
